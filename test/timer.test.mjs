...
test('stale running session reconciles to completed (no false recovery card)',()=>{const s=m.createSession(rounds,0);const v=m.reconcile(s,10_000_000);assert.equal(v.session.status,'completed')});
